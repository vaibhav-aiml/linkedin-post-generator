...
from backend.app.api.v1 import auth, posts, analyzer, export
...
app = FastAPI(
    ...
    description="Production-grade API for AI-powered LinkedIn Post & Message Generation, Analytics, and PDF Export.",
    version="2.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
)
